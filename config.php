...
*/
define('G5_DOMAIN', '');
define('G5_HTTPS_DOMAIN', 'http://04holic.co.kr');

/* SSL 적용 */
if(empty($_SERVER['HTTPS']) || $_SERVER['HTTPS'] == "off"){
 $redirect = 'http://04holic.co.kr'. $_SERVER['REQUEST_URI'];
...
/* ygh - 240329 리다이렉션 작업 */
if ($_SERVER['HTTP_HOST'] === 'www.04holic.co.kr') {
    $redirect_url = 'http://04holic.co.kr' . $_SERVER['REQUEST_URI'];
