...
define('G5_MYSQL_HOST', '121.78.91.46');
define('G5_MYSQL_USER', 'iuser07832');
define('G5_MYSQL_PASSWORD', 'intx!@12');
define('G5_MYSQL_DB', 'idb07832');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'b6a0e98f73443ff00e49c773e99526d6'); // 토큰 암호화에 사용할 키
