...
<section class="subpage borad pt140 mb120" id="bo_w">
<div class="container inner_container">
	...
	<?php if ($option) { ?>
    <div class="write_div bo_w_option">
    ...
    <div class="bo_w_tit write_div btl">
        <label for="wr_subject" class="title">제목</label> 
	...
	<div class="bo_w_tit write_div">
        <label for="wr_1" class="title">위치</label>
        <div class="write_div">
						<input type="text" name="wr_1" value="<?php echo $write['wr_1'] ?>" id="wr_1" required class="frm_input full_input required" size="50" maxlength="255" placeholder="위치명을 입력헤주세요">
        </div> 
    </div>
	
	<div class="bo_w_tit write_div">
        <label for="wr_subject" class="title">업체명</label>
        <div class="write_div">
						<input type="text" name="wr_2" value="<?php echo $write['wr_2'] ?>" id="wr_2" required class="frm_input full_input required" size="50" maxlength="255" placeholder="업체명을 입력헤주세요">
        </div> 
    </div>

    <div class="bo_w_tit write_div content">
		<label for="wr_subject" class="title long">내용</label>
	...
	<div class="bo_w_tit write_div file">
		<label for="wr_subject" class="title">파일 업로드</label>
    ...
    <div class="btn_confirm write_div">
        ...
        <button type="submit" id="btn_submit" accesskey="s" class="btn_submit btn">등록하기</button>
    </div>
    </form>
