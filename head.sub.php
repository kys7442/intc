...
if (defined('G5_IS_ADMIN')) {
    if(!defined('_THEME_PREVIEW_'))
		...
		echo '<link rel="stylesheet" href="'.run_replace('head_css_url', G5_ADMIN_URL.'/css/admin_change.css?ver='.G5_CSS_VER, G5_URL).'">'.PHP_EOL;
		add_javascript('<script src="'.G5_ADMIN_URL.'/admin_change.js?ver='.G5_JS_VER.'"></script>', 10);
} else {
    $shop_css = '';
